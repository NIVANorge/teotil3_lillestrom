...
The best monitoring data for Sagelva come from Vannmiljø stations `002-46599` (Sagelva ved Skjetten bro, F3) and `002-63540` (Fjellhammarelva, F10), both of which are part of waterbody `002-3899-R` (Fjellhamarelva - Sagelva) in the lower part of the catchment (@fig-sagelva). Skjetten bro is the downstream-most station with the longest monitoring record, beginning in 1995. 
...
![Trends in annual mean concentrations for waterbody `002-3899-R` (Fjellhamarelva - Sagelva). Solid red lines show statistically significant linear trends ($p ≤ 0.05$); dashed red lines show linear tendencies ($0.05 < p ≤ 0.10$); and black dashed lines show linear trends with $p > 0.10$.](./plots/concs/ann_trends_waterbodies_002-3899-R.png){#fig-sagelva-ann-concs width=800 fig-align="center"}
