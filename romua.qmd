...
![Maps of the Rømua catchment. Left: Land cover based NIBIO's AR50 dataset. Right: Point source discharges from industry and municipal wastewater plants (≥50 p.e.).](./plots/rømua.png){#fig-romua width=800 fig-align="center"}
...
Rømua receives discharges from three small wastewater plants connected to the municipal network (@tbl-romua-pt-sources). All three are located in the central part of the catchment (@fig-romua) and typical annual nutrient discharges are small. There are no industrial discharges within the catchment and contributions from spredt avløp and wastewater overflows (from Lillestrøm kommune) are small.
...
![Annual nutrient fluxes for waterbody `002-3659-R` (Rømua). Black lines show fluxes estimated from monitoring data; stacked bars show source-apportioned fluxes simulated by TEOTIL3.](./plots/modelled/mod_vs_obs_default_Rømua_waterbody_002-3659-R.png){#fig-teotil3-romua width=800 fig-align="center"}


![Mean source-apportionment for waterbody `002-3659-R` (Rømua) based on TEOTIL3 simulations from 2020 to 2024. For clarity, labels are omitted for sources contributing less than 3 %.](./plots/modelled/src_app_default_Rømua_waterbody_002-3659-R.png){#fig-romua-src-app width=800 fig-align="center"}

## Load reductions and scenarios {#sec-romua-avlast}

![Distributions of annual avlastningsbehovene (in percent) for the ten year period from 2015 to 2024 based on observed fluxes (red curves) and fluxes simulated by TEOTIL3 (blue curves). Vertical dashed lines show the median avlastningsbehov based on each dataset i.e. the load reduction that would have achieved GES in roughly half of the ten year period.](./plots/modelled/avlast_Rømua_waterbody_002-3659-R.png){#fig-romua-avlast width=800 fig-align="center"}

![Load reductions achieved in the Rømua catchment by scenarios A and B of [Wallhead *et al.* (2026)](https://www.miljodirektoratet.no/publikasjoner/2026/april-2026/modellering-av-oslofjorden-scenarier-med-redusert-menneskelig-belastning-for-a-oppna-god-okologisk-tilstand/). Black vertical lines on the plots for TOTN and TOTP show the median avlastningsbehov for GES estimated using observed data (@fig-romua-avlast).](./plots/modelled/oslomod_scens_Rømua.png){#fig-romua-scens width=800 fig-align="center"}
