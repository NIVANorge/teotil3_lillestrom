...
![Maps of the Gansåa catchment. Left: Land cover based NIBIO's AR50 dataset. Right: Point source discharges from industry and municipal wastewater plants (≥50 p.e.).](./plots/gansåa.png){#fig-gansaa width=800 fig-align="center"}
...
#| tbl-cap: "Industrial and municipal wastewater discharges within the Gansåa catchment."
#| echo: false
...
![Annual nutrient fluxes for waterbody `002-3655-R` (Gansåa). Black lines show fluxes estimated from monitoring data; stacked bars show source-apportioned fluxes simulated by TEOTIL3.](./plots/modelled/mod_vs_obs_default_Gansåa_waterbody_002-3655-R.png){#fig-teotil3-gansaa width=800 fig-align="center"}


![Mean source-apportionment for waterbody `002-3655-R` (Gansåa) based on TEOTIL3 simulations from 2020 to 2024. For clarity, labels are omitted for sources contributing less than 3 %.](./plots/modelled/src_app_default_Gansåa_waterbody_002-3655-R.png){#fig-gansaa-src-app width=800 fig-align="center"}

## Load reductions and scenarios {#sec-gansaa-avlast}

![Distributions of annual avlastningsbehovene (in percent) for the ten year period from 2015 to 2024 based on observed fluxes (red curves) and fluxes simulated by TEOTIL3 (blue curves). Vertical dashed lines show the median avlastningsbehov based on each dataset i.e. the load reduction that would have achieved GES in roughly half of the ten year period.](./plots/modelled/avlast_Gansåa_waterbody_002-3655-R.png){#fig-gansaa-avlast width=800 fig-align="center"}

![Load reductions achieved in the Gansåa catchment by scenarios A and B of [Wallhead *et al.* (2026)](https://www.miljodirektoratet.no/publikasjoner/2026/april-2026/modellering-av-oslofjorden-scenarier-med-redusert-menneskelig-belastning-for-a-oppna-god-okologisk-tilstand/). Black vertical lines on the plots for TOTN and TOTP show the median avlastningsbehov for GES estimated using observed data (@fig-gansaa-avlast).](./plots/modelled/oslomod_scens_Gansåa.png){#fig-gansaa-scens width=800 fig-align="center"}

```{python}
#| label: tbl-scen_summary-gansaa
#| tbl-cap: "Summary of avlastningsbehov and scenario results for Gansåa."
#| echo: false
