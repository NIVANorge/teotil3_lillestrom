...
![Maps of the Gansåa catchment. Left: Land cover based NIBIO's AR50 dataset. Right: Point source discharges from industry and municipal wastewater plants (≥50 p.e.).](./plots/gansåa.png){#fig-gansaa width=500 fig-align="center"}
