...
As noted in @sec-nitelva-monitoring, data from 2020 onwards come predominantly from Vannmiljø station station `002-79092` (Nitelva, Rud), whereas before 2020 most data come from a different site (`002-30586`; Rud Nitelva). Changes to the monitoring programme are  the most likely explanation for the sudden increase in measured fluxes, illustrating the large uncertainties in particulate nutrient loads estimated from low frequency sampling (see @sec-ann-loads). Another possible explanation is that a landslide occurred in Nittedal in autumn 2019, causing damage to the sewerage network and leading to increased wastewater discharges, as well as unusually high loads of phosphorus-rich clay particles. However, while may explain the very high measured loads of TOTP and SS in 2020, it cannot explain why loads remained high in 2023 and 2024 compared to pre-2019 levels.
