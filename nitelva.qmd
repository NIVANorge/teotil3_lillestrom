...
## Catchment overview {#sec-nitelva-overview}
 ...
 * 3000 to 12 000 tonnes/year for SS
...
Neither scenario makes a large difference to loads of TOC, since most organic carbon comes from background sources (@fig-nitelva-src-app). Nevertheless, the scenarios assume that upgraded wastewater treatment plants achieve treatment efficiencies of 95 % for BOF5 and KOF, leading to a roughly 5 % decrease in catchment scale TOC loads. Agricultural measures in both scenarios achieve a further TOC reduction of 1 to 2 %.
