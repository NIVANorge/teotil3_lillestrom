...
This chapter defines the area of interest for this project and provides a high level overview of the study catchments and their properties. [Chapter 3](./data-sources-models.qmd) describes the main sources of input data and the models used in the analysis, while [Chapter 4](./method.qmd) gives details of the workflow and methodology. Chapters 5 to 11 present results for each catchment separately, and [Chapter 12](./summary.qmd) provides a summary of the main results.
